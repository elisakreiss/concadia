...
df = pd.read_csv('../../../../../../../mnt/fs5/ekreiss/datasets/Wikipedia/fileextr_crawl.csv')
...
for index, row in df.iterrows():
    if not re.search("\.gif$", row['file_crawl']):
        ...
        filename = "../../../../../../../mnt/fs5/ekreiss/datasets/Wikipedia/wikicommons/wikiimages_raw/" + str(row['row_id']) + '.jpg'
        ...
        #     img_name = img_name
        try:
            # urllib.request.urlretrieve(url, "../../../../../../../mnt/fs5/ekreiss/datasets/Wikipedia/wikicommons/wikiimages_raw/" + img_name)
...
df.to_csv('../../../../../../../mnt/fs5/ekreiss/datasets/Wikipedia/data_wfilenames.csv', index=False)