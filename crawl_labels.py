...
# f = pd.read_csv('../../../../../../mnt/fs5/ekreiss/datasets/Wikipedia/fileextr.csv')
f = pd.read_csv('../../../../../../mnt/fs5/ekreiss/datasets/Wikipedia/articleextr.csv')
# f = f[:500]
...
with open('../../../../../../mnt/fs5/ekreiss/datasets/Wikipedia/fileextr_crawl.csv', 'w') as csv_file_crawl:
